...
const (
	...
	DefaultIntegreatlyOperatorQuayRepo     = "vmogilev_rhmi/integreatly-operator"
	DefaultIntegreatlyOperatorTestQuayRepo = "vmogilev_rhmi/integreatly-operator-test-harness"
