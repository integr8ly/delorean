...
func init() {
	...
	extractManifestsCmd.Flags().StringVar(&extractManifestsCmdOpts.extractDir, "extract-dir", "", "Extraction directory; the manifests will be inserted here. The directory will be autogenerated by default. This directory can then be used as a 'src-dir'")
