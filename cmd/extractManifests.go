...
var extractManifestsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if extractManifestsCmdOpts.tmpDir == "" {
...
func init() {
	...
	extractManifestsCmd.Flags().StringVar(&extractManifestsCmdOpts.tmpDir, "extract-dir", "", "Destination directory where to extract the manifests, which can be reused as src-dir, by default it wil be autogenerated")
