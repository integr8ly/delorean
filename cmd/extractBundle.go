...
func init() {
	...
	extractBundleCmd.Flags().StringVarP(&extractBundleCmdOpts.extractDir, "extract-dir", "e", "", "Destination directory where to extract the manifests, which can be reused as src-dir, by default it wil be autogenerated")
